...
A little (kind of) native osx app that reminds me to get up and stretch every x minutes. I say kind of because I used MacRuby to build this app, so you'll have to download MacRuby to run it. Also, it requires Growl & GrowlNotify to actually notify you.
